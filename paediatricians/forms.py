...
class PaediatricianForm(BaseForm):
    ...
    class Meta:
        model = Paediatrician
        title = "Add New Paediatrician"
        order = ['first_name', 'last_name', 'email', 'phone', 'qualification', 'clinic']

    def save(self, commit=True):
        instance = super(PaediatricianForm, self).save(commit=True)
