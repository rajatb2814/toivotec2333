...
import EditProfileDynamicForm from './EditProfileDynamicForm';
import { EditProifleFormSchema } from '..';
...
const EditProfileModal: React.FC<ModalProps> = ({ formSchema, modalTitle, isOpen, setIsOpen }) => {
  const closeModal = () => {
    setIsOpen(false);
  };
  return (
    <>
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" onClose={() => null} className="relative z-[1206]">
          <Transition.Child
            as={Fragment}
