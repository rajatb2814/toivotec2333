...
let smsSentTable = $("#com-pkg-sms-sent-table")
  ...
  .DataTable({
    ...
    columns: [
      { data: "id", title: "ID" },
      { data: "to_number", title: "To" },
      { data: "message", title: "Message" },
      { data: "status", title: "Status" },
      { data: "date_sent", title: "Date" },
    ],
    ...
    ajax: function (d, callback) {
      ...
      fetch(
        `${baseUrl}/api/?action=fetch_sms_records&${new URLSearchParams(flattenedObject)}`,
        {
          method: "GET",
          headers: {
    ...
    dom: '<"table-top" ><"table-search-box-sms-sent table-search-box">t<"table-bottom" <"table-info" i> <"table-pagination-box" l<"table-pagination-box-divider">p> >',
  ...
  $("#new-sms-btn").on("click", async function (event) {
          ...
          form: {
            ...
            ui_schema: {
              ...
              message: {
                ...
                "ui:syncEnabled": false,
                "ui:autocomplete": {},
                "ui:showCountryCodeSelector": false,
